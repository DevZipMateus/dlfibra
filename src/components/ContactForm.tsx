    ...
    <section className="section-padding bg-gradient-to-b from-scarlet-50 to-white" id="contact">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="glass-card rounded-xl p-6 animate-slideInRight">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Nossos Canais de Atendimento</h3>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="w-14 h-14 rounded-full bg-scarlet-100 flex items-center justify-center mr-4">
                  <Phone className="w-6 h-6 text-scarlet-600" />
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-1">Telefone</h4>
              ...
              <div className="flex items-start">
                <div className="w-14 h-14 rounded-full bg-scarlet-100 flex items-center justify-center mr-4">
                  <Mail className="w-6 h-6 text-scarlet-600" />
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-1">E-mail</h4>
              ...
              <div className="flex items-start">
                <div className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center mr-4">
                  <img src="/lovable-uploads/db774a34-6e4e-4b59-8c0f-b48860054798.png" alt="WhatsApp" className="w-7 h-7" />
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-gray-900 mb-1">WhatsApp</h4>
                  <p className="text-gray-600 text-lg">(11) 98765-4321</p>
            ...
            <div className="mt-8 p-4 bg-scarlet-50 rounded-lg border border-scarlet-100">
              <h4 className="text-xl font-semibold text-gray-900 mb-2 text-center">Horário de Atendimento</h4>

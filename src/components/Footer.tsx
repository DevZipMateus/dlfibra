            ...
            <ul className="space-y-2 grid grid-cols-2 md:grid-cols-1">
              {[
                ...
                <li key={label}>
                  <Link 
                    to={to} 
                    className="text-gray-300 hover:text-scarlet-300 transition-colors flex items-center text-sm md:text-base"
                  >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start">
                  ...
                  <div>
                    {items.map((item, i) => (
                      <p key={i} className="text-gray-300 text-sm md:text-base">{item}</p>
                    ))}
                  </div>
                </li>
              ))}

...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <main>
        <section className="pt-28 pb-16 md:pt-36 md:pb-20 bg-gradient-to-b from-scarlet-50 to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <span className={`inline-block py-1.5 px-4 rounded-full text-sm font-semibold bg-scarlet-100 text-scarlet-700 mb-6 opacity-0 ${isVisible ? 'animate-fadeIn' : ''}`}>
                Sobre Nós
              </span>
              <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight opacity-0 ${isVisible ? 'animate-slideDown' : ''}`}>
                Nossa <span className="text-scarlet-700">história</span> e valores
              </h1>
              <p className={`text-lg md:text-xl text-gray-600 mx-auto mb-8 max-w-3xl opacity-0 ${isVisible ? 'animate-slideDown delay-200' : ''}`}>
              ...
              <div className="space-y-16">
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  <div className="flex-1 md:text-right md:pr-10 mb-6 md:mb-0">
                    <div className="bg-scarlet-50 p-6 rounded-lg shadow-sm">
        ...
        {/* Numbers Section */}
        <section className="py-16 md:py-24 bg-scarlet-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <span className="inline-block py-1.5 px-4 rounded-full text-sm font-semibold bg-scarlet-100 text-scarlet-700 mb-4">
                Nossos Números
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
              <div className="bg-white p-8 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="w-16 h-16 mx-auto mb-6 bg-scarlet-100 rounded-full flex items-center justify-center">
                  <Clock className="w-7 h-7 text-scarlet-600" />
                </div>
                <h3 className="text-4xl font-bold text-scarlet-700 mb-3">{counts.years}</h3>
                <p className="text-gray-600 font-medium">Anos de Atuação</p>
              </div>
              
              <div className="bg-white p-8 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="w-16 h-16 mx-auto mb-6 bg-scarlet-100 rounded-full flex items-center justify-center">
                  <Users className="w-7 h-7 text-scarlet-600" />
                </div>
                <h3 className="text-4xl font-bold text-scarlet-700 mb-3">{counts.clients}+</h3>
                <p className="text-gray-600 font-medium">Clientes Atendidos</p>
              </div>
              
              <div className="bg-white p-8 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="w-16 h-16 mx-auto mb-6 bg-scarlet-100 rounded-full flex items-center justify-center">
                  <Award className="w-7 h-7 text-scarlet-600" />
                </div>
                <h3 className="text-4xl font-bold text-scarlet-700 mb-3">{counts.satisfaction}%</h3>
                <p className="text-gray-600 font-medium">Satisfação</p>
              </div>
              
              <div className="bg-white p-8 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="w-16 h-16 mx-auto mb-6 bg-scarlet-100 rounded-full flex items-center justify-center">
                  <TrendingUp className="w-7 h-7 text-scarlet-600" />
                </div>
                <h3 className="text-4xl font-bold text-scarlet-700 mb-3">{counts.professionals}</h3>
